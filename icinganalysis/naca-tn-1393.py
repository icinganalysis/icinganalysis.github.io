...
if __name__ == "__main__":
    ...
    reference_calculated_masses, reference_average_ems, reference_average_dias = mc.calc_masses_average_ems_diameters(
    ...
    lwc_percent_errors = []
    mvd_percent_errors = []
    header = ['Source of error', 'Estimated amount of error', 'Resultant percent error (E) Water content',
    ...
    lwc1, mvd1, rss1 = mc.find_lwc_mvd_from_dist(tk, u, p, reference_calculated_masses, time + delta_value,
                                                 assumed_distribution,
                                                 ice_density, )
    lwc_percents.append(calc_percent_difference(lwc, lwc1))
    mvd_percents.append(calc_percent_difference(mvd, mvd1))
    lwc2, mvd2, rss2 = mc.find_lwc_mvd_from_dist(tk, u, p, reference_calculated_masses, time - delta_value,
                                                 assumed_distribution,
                                                 ice_density)
    lwc_percents.append(calc_percent_difference(lwc, lwc2))
    mvd_percents.append(calc_percent_difference(mvd, mvd2))
    ...
    lwc_percents = []
    mvd_percents = []
    lwc1, mvd1, rss1 = mc.find_lwc_mvd_from_dist(tk, u + 0.44704 * delta_value, p, reference_calculated_masses, time,
                                                 assumed_distribution, ice_density)
    lwc_percents.append(calc_percent_difference(lwc, lwc1))
    mvd_percents.append(calc_percent_difference(mvd, mvd1))
    lwc1, mvd1, rss1 = mc.find_lwc_mvd_from_dist(tk, u - 0.44704 * delta_value, p, reference_calculated_masses, time,
                                                 assumed_distribution, ice_density)
    ...
    for dist in ('Langmuir A', 'Langmuir B', 'Langmuir C', 'Langmuir D', 'Langmuir E'):
        dist_calculated_masses, ems, dias = mc.calc_masses_average_ems_diameters(tk, p, u, lwc, mvd, time, dist,
                                                                                 ice_density)
        lwc1, mvd1, rss1 = mc.find_lwc_mvd_from_dist(tk, u, p, dist_calculated_masses, time, assumed_distribution,
                                                     ice_density)
        lwc_percents.append(calc_percent_difference(lwc, lwc1))
        mvd_percents.append(calc_percent_difference(mvd, mvd1))

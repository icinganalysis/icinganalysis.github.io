...
original_calc_em_with_distribution = NACA_TN_2904_impingement.ie
calc_em_with_distribution_to_use = NACA_TN_2904_impingement.ie
...
def calc_mass_average_em_diameter_with_distribution(
    ...
    for i in range(10):
        ...
        em_initial = calc_em_with_distribution_to_use(calc_k(tk, u, mvd, initial_diameter), k_phi,
                                                      distribution)
        mass_initial = (em_initial * lwc / 1000 * u * initial_diameter * length * time_in_icing)
        em_final = calc_em_with_distribution_to_use(calc_k(tk, u, mvd, initial_diameter), k_phi,
                                                    distribution)

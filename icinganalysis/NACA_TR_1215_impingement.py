...
data_table_iii = {  # k*phi
    ...
    40000: {
        'inv_ks': (4, 2, 1, 0.5, .2, .1, .05, .02, .01, .001),
        'ems_a': (0.005, 0.038, 0.110, 0.266, 0.548, 0.724, 0.832, 0.904, 0.938, 0.997),
        'ems_b': (0.010, 0.043, 0.117, 0.267, 0.534, 0.709, 0.821, 0.900, 0.936, 0.996),
        'ems_c': (0.015, 0.050, 0.126, 0.271, 0.524, 0.694, 0.810, 0.895, 0.934, 0.995),
        'ems_d': (0.022, 0.062, 0.141, 0.282, 0.518, 0.679, 0.796, 0.888, 0.931, 0.993),
        'ems_e': (0.031, 0.075, 0.156, 0.291, 0.510, 0.663, 0.779, 0.878, 0.925, 0.991),
    },
}
...
data_fig_4 = {  # phi
    ...
    100: {
        'ks': (.125, .25, .5, 1, 4, 16, 40, 320, 500, 1000),
        'ems': (0, .035, .157, .31, .68, .87, .924, .98, .99, .998),
    },
    1000: {
        'ks': (.125, .25, .5, 1, 4, 16, 40, 320, 500, 1000),
        'ems': (0, .025, .116, .25, .616, .83, .89, .97, .98, .993),
    },
    10000: {
        'ks': (.125, .25, .5, 1, 4, 16, 40, 320, 500, 1000),
...
lkphis = [log10(_) for _ in (10, 200, 1000, 3000, 10000, 40000)]
...
_delta_em_interp = interp2d(
    [log10(k) for k in data_fig_10[0]['ks']],
    [log10(phi) if phi > 10 ** l10phi_for_phi_0 else l10phi_for_phi_0 for phi in data_fig_10],
    [data_fig_10[phi]['delta_em'] for phi in data_fig_10]
)

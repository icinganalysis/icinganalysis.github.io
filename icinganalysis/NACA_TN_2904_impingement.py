...
data_table_iv = {  # k*phi
    ...
    40000: {
        'inv_ks': (4, 2, 1, 0.5, .2, .1, .05, .02, .01, .001),
        'ems_a': (0.005, 0.038, 0.110, 0.266, 0.548, 0.725, 0.832, 0.904, 0.941, 1.000),
        'ems_b': (0.010, 0.043, 0.117, 0.266, 0.534, 0.709, 0.821, 0.901, 0.939, 0.998),
        'ems_c': (0.015, 0.050, 0.126, 0.271, 0.524, 0.694, 0.810, 0.896, 0.936, 0.997),
        'ems_d': (0.022, 0.062, 0.141, 0.282, 0.518, 0.679, 0.796, 0.890, 0.932, 0.995),
        'ems_e': (0.031, 0.075, 0.156, 0.291, 0.510, 0.664, 0.780, 0.879, 0.926, 0.993),
    },
}

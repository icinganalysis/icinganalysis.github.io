...
table_II_original_data = {  # phi values as keys
    ...
    100: {
        ...
        'ems': (
            ...
            0.992, 0.994,),
        'betas': (
            0.065, 0.164, 0.246, 0.378, 0.478, 0.617, 0.705, 0.817, 0.801, 0.912, 0.955, 0.972, 0.981, 0.989, 0.993,
            0.996, 0.997,),
        'theta_degree': (
    ...
    1e5: {  # note that there is a typo "φ = 10^6" in the first part of Table II
        ...
        'ems': (
            ...
            0.890, 0.917, 0.933),
        'betas': (
            0.019, 0.054, 0.038, 0.135, 0.192, 0.243, 0.33, 0.476, 0.582, 0.657, 0.756, 0.811, 0.866, 0.89, 0.919,
            0.947,
            0.961, 0.969),
        'theta_degree': (
            2.1, 5.3, 18.1, 13.2, 18.8, 23.9, 32.3, 44.5, 52.4, 53, 65.4, 69.9, 74.7, 77, 79.8, 83, 84.6, 85.5),
    },
    1e6: {
        'ks': (0.16, 0.25, 0.36, 0.64, 1, 1.96, 3.24, 6.25, 9, 16, 36, 64, 100, 196, 324, 625, 900,),
        'ems': (
